      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <a href="https://github.com/yourusername/link-helper" className="text-slate-400 hover:text-slate-900 transition-colors">
        ...
        <div className="mt-8 pt-8 border-t border-slate-100 flex flex-col md:flex-row justify-between text-sm text-slate-500">
          <p>&copy; {new Date().getFullYear()} LinkFeed. Open Source (MIT License).</p>
